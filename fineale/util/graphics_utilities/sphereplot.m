% Plot data evolving on a sphere.
%
% function status = sphereplot(t,y,flag,varargin)
%
% Same usage as odeplot().
...
if nargin < 3 | isempty(flag)
  ...
  case 'init'
	...
	colr = ['b','r','g','m','c'];
	for i=1:ud.N
		ud.line(i) = plot3(ud.x(i,1),ud.y(i,1),ud.z(i,1),[color '.-'],'EraseMode','none');
	end
	hold off
	set(gca,'XLim',[-1 1]);
	set(gca,'YLim',[-1 1]);
