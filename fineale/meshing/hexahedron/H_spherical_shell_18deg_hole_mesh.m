function [fens,fes]=H_spherical_shell_18deg_hole_mesh(radius,thickness,ncirc,nmerid,nlayers, Convert)
...
[fens,fes] =H8_block(90,90-18,thickness,ncirc,nmerid,nlayers);
xy=fens.xyz;
for i=1:count (fens)
