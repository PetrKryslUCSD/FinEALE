function [fens,fes] = H64_block(Length,Width,Height,nL,nW,nH)
% Mesh of a 3-D block of H64 finite elements
%
% function [fens,fes] = H64_block(Length,Width,Height,nL,nW,nH)
%
% Arguments:
...
% third direction (x,y,z). Finite elements of type H64.
%
% Output:
...
%
% Examples:
%     [fens,fes] = H64_block(2,3,4, 1,2,3);
%     drawmesh({fens,fes},'nodes','fes','facecolor','none'); hold on
%
% See also: H8_block, H8_to_H64
%
