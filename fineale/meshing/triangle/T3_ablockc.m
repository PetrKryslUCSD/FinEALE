function [fens,fes] = T3_ablockc(Length,Width,nL,nW,options)
% Mesh of T3 elements of a rectangle.  Alternate orientation, bisected corners.
%
% function [fens,fes] = T3_ablockc(Length,Width,nL,nW,options)
%
% Range xy=<0,Length> x <0,Width>
...
% 
% Examples: 
%     [fens,fes] = T3_ablockc(3.1,2.2,3,2,[]);
