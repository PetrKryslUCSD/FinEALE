function [fens,fes] = T3_cblock(Length,Width,nL,nW,options)
% Mesh of a rectangle.  Cross-pattern mesh.
%
% function [fens,fes] = T3_cblock(Length,Width,nL,nW,options)
%
% <0,Length> x <0,Width>
% Divided into triangular (t3) elements: nL, nW in the first, second direction (x,y).
% The mesh is cross-pattern.
% options = Attributes recognized by the constructor of feset_T3.
% 
% Examples: 
%     [fens,fes] = T3_cblock(3.1,2.2,3,2,[]);
