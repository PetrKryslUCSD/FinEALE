function [fens,fes] = T10_quarter_plate_w_hole(InternalRadius, Width, Thickness, nR, nW, nL, blockh)
% T10 mesh of a solid hollow cylinder.
% 
% [fens,fes] = T10_quarter_plate_w_hole(InternalRadius, Width, Length, nC, nT, nL, blockh)
%     
% InternalRadius= radius of the circular hole,
% Width = width of the plate
% Length=  length of the cylinder
% nR, nW, nL= number of elements radially, through the
...
%
% Examples: 
%     [fens,fes] = T10_quarter_plate_w_hole(1.0, 2.5, 1.5, 17, 2, 3)
