% Direct time integration of pin-pin prestressed wire.  Runge-Kutta rule.
function wireFEM2
...
% The effective mass matrix for the first order systemin
Mtilda= [eye(N_f),  zeros(N_f);...
           zeros(N_f),   Mg];
% Run the integrator
[ts,ys]=ode23(@f,[0, 150],[w0;v0],odeset('Mass',Mtilda,'RelTol',1e-3));
