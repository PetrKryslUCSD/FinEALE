% Lug and pin.
% Augmented Lagrangean contact approach. Node-to-surface contact.
function  pin_and_lug_contact_aug_N2S_h8
disp('Lug and rigid pin. Augmented Lagrangean contact algorithm. Node-to-surface contact.');
