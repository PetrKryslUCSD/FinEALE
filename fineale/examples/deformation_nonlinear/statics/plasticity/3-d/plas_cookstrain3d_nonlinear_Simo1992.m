...
n=2;
[fens,fes] = H8_block(48,44,16/n, n, aspect*n, 1);
...
stabprop = property_deformation_neohookean(struct('E',delta_expon*(sigma_res-sigma_y)+K_lin,'nu',nu));
stabmater = material_deformation_neohookean_triax(struct('property',stabprop));

region.femm= femm_deformation_nonlinear_h8msgso(struct ('material',mater,'stabilization_material',stabmater,'fes',fes,'integration_rule',gauss_rule(struct('dim',3,'order',2))));
