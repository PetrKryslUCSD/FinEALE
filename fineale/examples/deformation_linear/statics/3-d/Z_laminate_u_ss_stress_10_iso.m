...
function Z_laminate_u_ss_stress_10_iso
    ...
    model_data.postprocessing.stress_range=1e4*[-1.5,+1.5];
   model_data.postprocessing.stress_component= 5;
    model_data.postprocessing.stress_range=1e4*[-5,+5];
