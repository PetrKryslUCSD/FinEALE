classdef  fe_set_T6 < fe_set_2_manifold
% T6 (triangle with six nodes)  finite element (FE) set class.
%
%
    ...
    methods % constructor
        ...
        function self = fe_set_T6(Parameters)
            % Constructor.
            % Parameters:
    ...
    methods % concrete methods
        ...
        function draw (self, gv, context)
            ...
            %
            context.faces=[1,4,6;2,5,4;3,6,5;4,5,6];
            context.edges= [1,4,2,5,3,6,1];
            node_pc=[0,0;1,0;0,1;0.5,0;0.5,0.5;0,0.5];
        ...
        function   draw_isosurface(self, gv, context)
            ...
            [f,v]= isosurf_edges([conns(:,[1,4,6]);conns(:,[4,2,5]);conns(:,[3,6,5]);conns(:,[4,5,6]);], context.x, context.u, context.scalarfield, context.isovalue);
        ...
        function val =boundary_conn(self)
            ...
            conn =self.conn;
            val = [conn(:,[1, 2, 4]);conn(:,[2, 3, 5]);conn(:,[3, 1, 6])];
        end
