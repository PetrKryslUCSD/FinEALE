...
%
    ...
    [npts_v Ns_v Nders_v w_v pc_v] = integration_data_volumetric (self);
    [npts_s Ns_s Nders_s w_s pc_s] = integration_data_deviatoric (self);
    ...
    for m=1:length(fe_list)
        ...
        for j=1:npts_v % loop over all volumetric-strain quadrature points
            ...
            B = self.hBlmat(self,Ns_v{j},Ndersp*Rm,c,Rm);% material strain-global displacement
            context.strain = B*U;% strain in material coordinates
