classdef femm_deformation_linear_h8msgso < femm_deformation_linear
    ...
    methods % constructor
        ...
        function self = femm_deformation_linear_h8msgso (Parameters)
        % Parameters
        ...
        % nconstrained  = used by the stabilization FEMM, number of constrained modes in the material matrix
            ...
            if (isfield(Parameters,'stabilization_material'))
                ...
                if (self.material.property.nu<0.2)
                    nu=self.material.property.nu;
                else
                    nu=0.2+ (self.material.property.nu-0.2)/2;
                end
                %                 nu=0.; % Experiment in
                prop = property_deformation_linear_iso (struct('E',E,'nu',nu));
                self.stabilization_material = material_deformation_linear_triax(struct('property',prop));
            end
